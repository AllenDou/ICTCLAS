...
ICTCLAS_API int ICTCLAS_ParagraphProcessE(const char *sParagraph,char *sResult,int bPOStagged=1);
/*********************************************************************
 *
...
class  __declspec(dllexport) CICTCLAS {
	...
	public:
		...
		//Process a file，类似于C下的ICTCLAS_ParagraphProcess
		const result_t * ParagraphProcessA(const char *sParagraph,int *pResultCount);
		//Process a file，类似于C下的ICTCLAS_ParagraphProcessA
