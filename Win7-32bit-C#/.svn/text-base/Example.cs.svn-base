...
namespace win_csharp
{
	...
	class Class1
	{
        ...
        [DllImport(path, CharSet = CharSet.Ansi, EntryPoint = "ICTCLAS_ParagraphProcessE")]
        public static extern int ICTCLAS_ParagraphProcessE(String sParagraph, StringBuilder sResult,int bPOStagged);
